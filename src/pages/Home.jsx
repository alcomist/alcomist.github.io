...
import { Smartphone, Gamepad2, LayoutTemplate, Globe, Mail, Send, Database } from 'lucide-react';
  ...
  return (
    <div className="fade-in" style={{ position: 'relative' }}>
      <section className="hero">
        ...
        <p className="subtitle" style={{ fontSize: '1.2rem', marginBottom: '24px' }}>Software Engineer & Maker</p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className="card glass-panel" style={{ transition: 'transform 0.2s ease, box-shadow 0.2s ease' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              <a href="https://opensearch.org/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>OpenSearch</a>
              <a href="https://www.elastic.co/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>Elasticsearch</a>
              <a href="https://kafka.apache.org/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>Kafka</a>
              <a href="http://gearman.org/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>Gearman</a>
            </div>
          </div>
          <div className="card glass-panel" style={{ transition: 'transform 0.2s ease, box-shadow 0.2s ease' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              <a href="https://react.dev/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>React</a>
              <a href="https://vuejs.org/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>Vue</a>
              <a href="https://angular.dev/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>Angular</a>
              <a href="https://spring.io/projects/spring-boot" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>Spring Boot</a>
              <a href="https://fastapi.tiangolo.com/" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>FastAPI</a>
            </div>
          </div>
          <div className="card glass-panel" style={{ transition: 'transform 0.2s ease, box-shadow 0.2s ease' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              <a href="https://play.google.com/store/apps" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', padding: '4px 10px', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--primary-color)', borderRadius: '12px', textDecoration: 'none', transition: 'background 0.2s ease' }} onMouseOver={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.2)'} onMouseOut={(e) => e.target.style.background = 'rgba(59, 130, 246, 0.1)'}>Google Play Store</a>
            </div>
          </div>
          <div className="card glass-panel" style={{ transition: 'transform 0.2s ease, box-shadow 0.2s ease' }}>
      ...
      {/* Contact Section */}
      <section style={{ marginTop: '80px', padding: '40px', background: 'rgba(59, 130, 246, 0.05)', borderRadius: '24px', border: '1px solid rgba(59, 130, 246, 0.1)', textAlign: 'center' }}>

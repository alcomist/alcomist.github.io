...
const translations = {
  ko: {
    ...
    home: {
      ...
      pipeline_title: "대규모 데이터 파이프라인 구축",
      pipeline_desc: "다양한 오픈소스 분산 처리 기술을 활용하여 대규모 데이터 파이프라인을 구축하고 최적화합니다.",
      fullstack_title: "Full Stack 개발",
      fullstack_desc: "SaaS 플랫폼, Frontend, Backend 등 다양한 환경의 웹 서비스를 설계하고 개발합니다.",
  ...
  en: {
    ...
    home: {
      ...
      pipeline_title: "Large-scale Data Pipelines",
      ...
      fullstack_desc: "Designing and developing comprehensive web services across SaaS, Frontend, and Backend environments.",
      ...
      request_modal_name: "Name / Company",
